class TaylorArchive {
    ...
    populateFilters() {
      ...
      ;[...interviewers]
        .sort()
        .forEach((interviewer) => this.addSelectOption(this.elements.interviewerFilter, interviewer))
    }
    ...
    applyFilters() {
      this.filteredData = this.rawData.filter((item) => {
        ...
        const interviewerMatch = !this.currentFilters.interviewer || item.Interviewer === this.currentFilters.interviewer
